...
const derived = hdWallet.hdWallet.selectAccount(0).selectRoles([Roles.NightExternal, Roles.Dust]).deriveKeysAt(0);
...
const dustAddress = DustAddress.encodePublicKey(getNetworkId(), dustSecretKey.publicKey);
...
console.log(`  ${address}\n`);
console.log(`  DUST address (for programmatic registration):`);
