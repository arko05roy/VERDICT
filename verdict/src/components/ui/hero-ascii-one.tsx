      ...
      <div className="absolute top-0 left-0 right-0 z-20 border-b border-white/20">
        <div className="container mx-auto px-4 lg:px-8 py-3 lg:py-4 flex items-center justify-between">
          <div className="flex items-center gap-2 lg:gap-4">
            ...
            <span className="text-white/60 text-[8px] lg:text-[10px] font-mono">ZK INTEGRITY</span>
          </div>
        ...
        <div className="w-full lg:w-1/2 px-6 lg:px-16 lg:pr-[10%]">
          <div className="max-w-lg relative lg:ml-auto">
            ...
            <div className="relative">
              ...
              <h1 className="text-3xl lg:text-6xl font-bold text-white mb-3 lg:mb-4 leading-tight font-mono tracking-wider lg:-ml-[5%]" style={{ letterSpacing: '0.1em' }}>
                VERDICT
              </h1>
            </div>
            ...
            <div className="relative">
              <p className="text-xs lg:text-base text-gray-300 mb-5 lg:mb-6 leading-relaxed font-mono opacity-80">
                Every game server lies to you. We mathematically prove they can&apos;t. 10 ZK checks, zero trust required — the only protocol that makes cheating a cryptographic impossibility.
              </p>
            ...
            <div className="flex flex-col lg:flex-row gap-3 lg:gap-4">
              <Link href="/overview" className="relative px-5 lg:px-6 py-2 lg:py-2.5 bg-transparent text-white font-mono text-xs lg:text-sm border border-white hover:bg-white hover:text-black transition-all duration-200 group text-center">
              ...
              <Link href="/integrate" className="relative px-5 lg:px-6 py-2 lg:py-2.5 bg-transparent border border-white text-white font-mono text-xs lg:text-sm hover:bg-white hover:text-black transition-all duration-200 text-center" style={{ borderWidth: '1px' }}>
                VIEW DOCUMENTATION
              </Link>
            </div>
            ...
            <div className="hidden lg:flex items-center gap-2 mt-6 opacity-40">
              ...
              <div className="flex-1 h-px bg-white"></div>
              <span className="text-white text-[9px] font-mono">VERDICT.PROTOCOL</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="absolute left-0 right-0 z-20 border-t border-white/20 bg-black/40 backdrop-blur-sm" style={{ bottom: '5vh' }}>
        <div className="container mx-auto px-4 lg:px-8 py-2 lg:py-3 flex items-center justify-between">
          <div className="flex items-center gap-3 lg:gap-6 text-[8px] lg:text-[9px] font-mono text-white/50">
            <span className="hidden lg:inline">PROTOCOL.ACTIVE</span>
            <span className="lg:hidden">PRTCL.ACT</span>
          ...
          <div className="flex items-center gap-2 lg:gap-4 text-[8px] lg:text-[9px] font-mono text-white/50">
            ...
            <span className="hidden lg:inline">10 CHECKS : ZK</span>
          </div>
        </div>
      </div>
